...
// Get the total number of games and total pledged amount
const totalGames = GAMES_JSON.length;

// Get the total number of unfunded games
...
const displayStr = `
  ...
  Currently, ${totalUnfundedGames === 1 ? '1 game remains' : `${totalUnfundedGames} games remain`} unfunded.
